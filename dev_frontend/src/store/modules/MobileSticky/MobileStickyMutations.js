export default {
  ...
  REMOVE_ITEM_FROM_INACTIVE(state, payload) {
    const inactiveCell = state.inactiveItems

    inactiveCell.splice( payload.cellId, 1 )
  },
  ...
  PUT_TO_INACTIVE( state, payload ) {
    state.inactiveItems.push( payload.item )
  },

  CLEAR_INACTIVE_ITEMS( state ) {
    state.inactiveItems = []
  },
